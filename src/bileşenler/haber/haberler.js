...
function haberYapici(haber) {
  const anaSablon = document.createElement("div");
  anaSablon.classList.add("article");
  ...
  ikiParagraf.textContent = haber.ikinciParagraf;

  const ucParagraf = document.createElement("p");
  ucParagraf.textContent = haber.ucuncuParagraf;

  const ucNokta = document.createElement("span");
  ucNokta.textContent = "+";
  ucNokta.classList.add("expandButton");
  ucNokta.addEventListener("click", (e) => {
    const acikHaber = document.querySelector(".article-open");
    if (acikHaber !== null) acikHaber.classList.remove("article-open");
    anaSablon.classList.toggle("article-open");
  });

  anaSablon.appendChild(haberBasligi);
  anaSablon.appendChild(haberTarihi);
  anaSablon.appendChild(ilkParagraf);
  anaSablon.appendChild(ikiParagraf);
  anaSablon.appendChild(ucParagraf);
  anaSablon.appendChild(ucNokta);
  return anaSablon;
}
